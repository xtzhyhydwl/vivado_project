...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../barometer_sensor.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../barometer_sensor.srcs/sources_1/bd/design_1/ipshared/02c8/hdl/verilog" \
       +incdir+"$ref_dir/../../../../barometer_sensor.srcs/sources_1/bd/design_1/ipshared/1313/hdl" \
       +incdir+"../../../../barometer_sensor.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../barometer_sensor.srcs/sources_1/bd/design_1/ipshared/02c8/hdl/verilog" \
       +incdir+"../../../../barometer_sensor.srcs/sources_1/bd/design_1/ipshared/1313/hdl" \
       +incdir+"K:/Vivado2017.4/Vivado/2017.4/data/xilinx_vip/include"
}
